...
type Config struct {
	...
	// Controls the display of the request duration (in milliseconds) for "Try it out" request.
	// default: false
	...
	// MUST be a function. Function to intercept remote definition, "Try it out", and OAuth 2.0 request.
	...
	// MUST be a function. Function to intercept remote definition, "Try it out", and OAuth 2.0 response.
	...
	// Possible values are ["get", "put", "post", "delete", "options", "head", "patch", "tracer"]
	// default: nil
	...
	// For example for locally deployed validator (https://github.com/swagger-api/validator-badge).
	// Setting it to either none, 127.0.0.1 or localhost will disable validation.
	// default: ""
	ValidatorUrl string `json:"validatorUrl,omitempty"`

	// If set to true, enables passing credentials, as defined in the Fetch standard, in CORS request that are sent by the browser.
...
type OAuthConfig struct {
	// externalID of the client sent to the OAuth2 provider.
	// default: ""
